...
# A atualizacao pela tela foi removida: quem atualiza o servidor e o
# servidortualizar.bat (git pull + restart da tarefa). Os endpoints
# /atualizador/* que baixavam e extraiam o update.zip sairam junto --
# extrair arquivos por cima de um diretorio gerido por git daria conflito.
# A versao em uso agora vem de /versao, acima.
